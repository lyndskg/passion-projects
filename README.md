...
30. [maxnmastered](https://github.com/lyndskg/maxnmastered)
   - volume booster and AI-powered live mastering service for macOS
31. [spotify-to-mp3-xor-wav](https://github.com/lyndskg/spotify-to-mp3-xor-wav)
32. [spotify-algo-enhancer](https://github.com/lyndskg/spotify-algo-enhancer)
33. [yt-soundcloud-spotify-to-mixing-software](https://github.com/lyndskg/yt-soundcloud-spotify-to-mixing-software)
34. [what-to-mix-next](https://github.com/lyndskg/what-to-mix-next)
...
39. [free4all4streaming4free](https://github.com/lyndskg/free4all4streaming4free)
...
40. [meta-foodclub](https://github.com/lyndskg/meta-foodclub)
   - based on Yelp, Beli, Google, Michelin, TripAdvisor, etc
   - does additional web and social media scraping
41. [meta-nightclub](https://github.com/lyndskg/meta-nightclub)
   - based on Clubbable, Discotech, ra.co, local events (e.g. from facebook), Yelp, Google, etc
42. [meta-filmclub](https://github.com/lyndskg/meta-filmclub)
...
46. [CMakeMe](https://github.com/lyndskg/CMakeMe) ![](https://geps.dev/progress/100) 
